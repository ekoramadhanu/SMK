...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <?= form_error('namaPetugas', '<div class="alert alert-danger" role="alert">', '</div>')?>
              <div class="mb-2 d-flex justify-content-end">
                <button class="btn btn-primary" data-toggle="modal" data-target="#petugasModal">Tambah Petugas</button>
              </div>
                  ...
                  <tbody>
                    <?php  
                      ...
                      <tr>
                        ...
                        <td>
                         <?php 
                           echo "<button type='submit' class='ubahPetugas btn btn-outline-danger btn-sm mr-1' data-id='".$item->id_petugas."'data-toggle='modal' data-target='#updateModal'><i class='fas fa-fw fa-pencil-alt'></i></button>";
                           echo "<button type='submit' class='hapusPetugas btn btn-outline-success btn-sm' data-id='".$item->id_petugas."'data-toggle='modal' data-target='#deleteModal'><i class='fas fa-fw fa-trash-alt'></i></button>";
                         ?>
                        </td>
                      </tr>
                    <?php  
  ...
  <div class="modal fade" id="petugasModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Fromulir Penambahan Petugas</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body">
        <form method="post" action="<?=base_url('Petugas')?>" class="needs-validation" novalidate>
          <div class="form-group">
            <label for="exampleInputEmail1">Username</label>
            <input type="text" class="form-control form-control-user" id="username" name="username" required style="color:black" placeholder="Username Petugas">
          ...
          <div class="form-group">            
            ...
            <input type="text" class="form-control form-control-user" id="namaPetugas" name="namaPetugas" required style="color:black" placeholder="Nama Petugas">
            <div class="invalid-feedback">
              <p class="pl-2 text-capitalize">Nama Petugas tidak boleh kosong</p>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="invalid-feedback">
            <p class="pl-2 text-capitalize">level tidak boleh kosong</p>
          </div>
        </div>
          <div class="modal-footer">
  ...
  <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Fromulir Ubah Petugas</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body">
        <form method="post" action="<?=base_url('Petugas/ubahDataPetugas')?>" class="form-ubah needs-validation" novalidate>
          <div class="form-group">
          <label for="exampleInputEmail1">level Pengguna</label>          
          <select class="form-control custom-select" name="level" required>
            <option disabled selected value="">Pilih Level</option>
   ...
   <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form action="<?=base_url('Petugas/hapusDataPetugas')?>" class="form-hapus">
            <button class="btn btn-secondary" type="button" data-dismiss="modal" >Cancel</button>
            <button type="submit" class="btn btn-primary btnHapusPetugas" >Hapus</button>
          </form>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    (function() {
     ...
     $('.hapusPetugas').click(function () {
      ambilVal= $(this).attr('data-id');        
      console.log(ambilVal);      
      $('.form-hapus').on('click','.btnHapusPetugas',function(e){        
